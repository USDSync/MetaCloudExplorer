...
def draw_text_on_image_at_position(input_image_path:str,  output_path:str, textToDraw:str, x:int, y:int):
    image = Image.open(input_image_path)
    draw = ImageDraw.Draw(image)
    font = ImageFont.truetype("temp\\airstrike.ttf", size=44)
    draw.text((x, y), textToDraw, font_size=44, font=font, fill="blue")
...
if __name__ == "__main__":
    ...
    draw_text_on_image_at_position("temp\\carbon.jpg", "temp\\output.jpg", "Mmmuuuurrrrrrrrrr", 10,10)
